...
public class RequestUtility {
	...
	public RequestUtility() throws NoSuchAlgorithmException, KeyStoreException, KeyManagementException {
	...
	String pdpResponse(PDPRequest request) throws ClientProtocolException, IOException {
